...
function DIISG_control() 
{
	...
	echo $DIISG_dir . '" name="DIISG_dir" id="DIISG_dir" /><br>Default(In future dont keep the images in this "drop-in-image-slideshow-gallery" folder. Best practice is to change this default path) : wp-content/plugins/drop-in-image-slideshow-gallery/gallery/</p>';
